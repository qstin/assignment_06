...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/auto-pairs,~/.vim/bundle/jedi-vim,~/.vim/bundle/nerdtree,~/.vim/bundle/sparkup,~/.vim/bundle/vim-fugitive,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/bundle/jedi-vim/after,~/.vim/after
set shiftwidth=4
set showmatch
set smarttab
...
silent only
cd ~/repos/GIS/assignment_06
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +3 point.py
badd +13 tests/point_test.py
badd +6 ~/repos/GIS/assignment_05/tests/functional_test.py
badd +1 README.md
args .
edit tests/point_test.py
